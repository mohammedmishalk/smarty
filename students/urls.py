...
urlpatterns = [
    ...
    path("ls/<int:course_id>/",views.Weeks_view,name="Weeks"),
    path("ls/<int:course_id>/<int:week>/<str:cont>",views.lesson,name="lessons"),
    path("ls/<int:course_id>/<int:week>/<str:cont>/<int:choice>",views.choice,name="choice"),
